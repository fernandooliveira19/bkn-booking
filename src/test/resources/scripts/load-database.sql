...
INSERT INTO public.booking(id, traveler_id,check_in, check_out, amount, adults, children, booking_status,payment_status, insert_date, last_update, rating, amount_pending, observation, contract_type)
VALUES(10, 1, '2021-10-01 10:00', '2021-10-30 18:30', 1500.00, 5, 2, 'RESERVED', 'PENDING', '2021-10-05 12:40', null, null, 200.0, 'Primeira reserva', 'DIRECT');
