...
public interface BookingRepository extends JpaRepository<Booking,Long> {
 ...
 @Query(value = "select b from booking b where b.bookingStatus in ('RESERVED', 'PRE_RESERVED') and :checkIn between b.checkIn and b.checkOut or (:checkOut between b.checkIn and b.checkOut) or (b.checkIn >= :checkIn and b.checkOut <= :checkOut)")
